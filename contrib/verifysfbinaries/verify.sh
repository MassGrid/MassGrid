...
###   This script attempts to download the signature file SHA256SUMS.asc from massgrid.org
...
WORKINGDIR="/tmp/massgrid"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://massgrid.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://massgrid.org/bin/"
VERSIONPREFIX="massgrid-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'massgrid-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[massgrid-]<version>-[rc[0-9]] (example: massgrid-0.9.2-rc1)"
   echo "wget output:"
