...
###   This script attempts to download the signature file SHA256SUMS.asc from mlgbcoin.org
...
WORKINGDIR="/tmp/mlgbcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://mlgbcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://mlgbcoin.org/bin/"
VERSIONPREFIX="mlgbcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'mlgbcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[mlgbcoin-]<version>-[rc[0-9]] (example: mlgbcoin-0.9.2-rc1)"
   echo "wget output:"
