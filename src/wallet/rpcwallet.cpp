...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current MassGrid address for receiving payments to this account.\n"
            "\nArguments:\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", \"tabby\"")
        );
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"")
            + HelpExampleRpc("getaccount", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"")
        );
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 6)
        throw runtime_error(
            "sendtoaddress \"massgridaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is)\n"
            ...
            "                             The recipient will receive less amount of MassGrid than you enter in the amount field.\n"
            "6. \"use_is\"      (bool, optional) Send this transaction as InstantSend (default: false)\n"
            "\nResult:\n"
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"massgridaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"massgridaddress\"  (string, required) The massgrid address to send to.\n"
            "2. \"amount\"      (numeric, required) The amount in mgd to send. eg 0.1\n"
            "3. \"comment\"     (string, optional) A comment used to store what the transaction is for. \n"
            "                             This is not part of the transaction, just kept in your wallet.\n"
            "4. \"comment-to\"  (string, optional) A comment to store the name of the person or organization \n"
            "                             to which you're sending the transaction. This is not part of the \n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"massgridaddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given massgridaddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", 6")
       );
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tomassgridaddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a massgrid address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The massgrid address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less massgrids than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\":0.01,\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\":0.01,\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\":0.01,\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    {
        CMassGridAddress address(name_);
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid MassGrid address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\",\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\",\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\"]\"")
        ;
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("gettransaction", "\"6dd292efaeb254b1c1aafd2d5b2d900048ea73cb1f3bb8d099f38e408e069c8e\"")
            + HelpExampleCli("gettransaction", "\"6dd292efaeb254b1c1aafd2d5b2d900048ea73cb1f3bb8d099f38e408e069c8e\" true")
            + HelpExampleRpc("gettransaction", "\"6dd292efaeb254b1c1aafd2d5b2d900048ea73cb1f3bb8d099f38e408e069c8e\"")
        );
...
UniValue abandontransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\nExamples:\n"
            + HelpExampleCli("abandontransaction", "\"6dd292efaeb254b1c1aafd2d5b2d900048ea73cb1f3bb8d099f38e408e069c8e\"")
            + HelpExampleRpc("abandontransaction", "\"6dd292efaeb254b1c1aafd2d5b2d900048ea73cb1f3bb8d099f38e408e069c8e\"")
        );
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Wallet encrypted; MassGrid server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the massgrid address\n"
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            CMassGridAddress address(input.get_str());
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid MassGrid address: ")+input.get_str());
            if (setAddress.count(address))
    ...
    BOOST_FOREACH(const COutput& out, vecOutputs) {
        ...
        CTxDestination address;
        if (ExtractDestination(out.tx->vout[out.i].scriptPubKey, address)) {
            entry.push_back(Pair("address", CMassGridAddress(address).ToString()));
