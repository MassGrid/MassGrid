...
#ifndef MASSGRID_WALLET_WALLET_H
#define MASSGRID_WALLET_WALLET_H
...
public:
    ...
    ATTRIBUTE_MEMBER_FUNC(CPUType);
    ATTRIBUTE_MEMBER_FUNC(CPUThread);
    ATTRIBUTE_MEMBER_FUNC(MemoryType);
    ATTRIBUTE_MEMBER_FUNC(MemoryCount);
    ATTRIBUTE_MEMBER_FUNC(GPUType);
...
public:
    ...
    /// Get 1000MGD output and keys which can be used for the Masternode
    ...
    CPubKey CreatePubKey(const std::string& addr);
    ...
    bool CreateTransaction(const std::vector<CRecipient>& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosRet,
                           std::string& strFailReason, const CCoinControl *coinControl = NULL, bool sign = true, AvailableCoinsType nCoinType=ALL_COINS, bool fUseInstantSend=false,bool fUseOpReturn=false,std::string masternodeOutPoint="");
...
#endif // MASSGRID_WALLET_WALLET_H
