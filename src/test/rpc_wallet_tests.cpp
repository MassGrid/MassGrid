...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CMassGridAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CMassGridAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CMassGridAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CMassGridAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    /*********************************
     *          getlocktransactionsfromaddress
     *********************************/
    BOOST_CHECK_NO_THROW(CallRPC("getlocktransactionsfromaddress"));
    /*********************************
     *          listlockunspent
     *********************************/
    ...
    BOOST_CHECK(CMassGridAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CMassGridAddress(arr[0].get_str()).Get() == demoAddress.Get());
