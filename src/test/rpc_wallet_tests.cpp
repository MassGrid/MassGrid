...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CMassGridAddress demoAddress = CMassGridAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CMassGridAddress setaccountDemoAddress = CMassGridAddress(CTxDestination(setaccountDemoPubkey.GetID()));
