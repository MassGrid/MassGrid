...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CMLGBcoinAddress demoAddress = CMLGBcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CMLGBcoinAddress setaccountDemoAddress = CMLGBcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CMLGBcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CMLGBcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
