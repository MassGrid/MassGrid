...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2094429999999990LL).write() == "20999999.99999990");
    BOOST_CHECK(ValueFromAmount(2094429999999999LL).write() == "20999999.99999999");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20944299.9999999")), 2099999999999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20944299.99999999")), 2099999999999999LL);
...
BOOST_AUTO_TEST_CASE(json_parse_errors)
{
    ...
    BOOST_CHECK_THROW(ParseNonRFCJSONValue("1.0]"), std::runtime_error);
    // MGD addresses should fail parsing
