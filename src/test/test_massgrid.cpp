...
#define BOOST_TEST_MODULE MassGrid Test Suite

#include "test_massgrid.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_massgrid_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
