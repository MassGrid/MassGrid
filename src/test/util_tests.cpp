...
BOOST_AUTO_TEST_CASE(test_ParseFixedPoint)
{
    ...
    BOOST_CHECK(ParseFixedPoint("9442999999.99999999", 8, &amount));
    BOOST_CHECK_EQUAL(amount, 944299999999999999LL);
    BOOST_CHECK(ParseFixedPoint("-9442999999.99999999", 8, &amount));
    BOOST_CHECK_EQUAL(amount, -944299999999999999LL);
    ...
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000009", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("-94429999999.99999999", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("94429909999.09999999", 8, &amount));
