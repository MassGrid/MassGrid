...
#ifndef MASSGRID_TEST_SCRIPTNUM10_H
#define MASSGRID_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MassGrid 0.10.0, for cross-comparison.
 */
public:
