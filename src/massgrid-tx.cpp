...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MassGrid Core massgrid-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  massgrid-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded massgrid transaction") + "\n" +
              "  massgrid-tx [options] -create [commands]   " + _("Create hex-encoded massgrid transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded massgrid transaction
