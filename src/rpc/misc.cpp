...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "massgrid|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "massgrid")
            + HelpExampleRpc("debug", "massgrid,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"")
            + HelpExampleRpc("validateaddress", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"")
        );
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\",\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\\\",\\\"mpg2Ki3bacC2F34yR3Q9zBmD8jToeTrGLL\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\", \"signature\", \"my message\"")
        );
...
{
    if (type == 2) {
        address = CMassGridAddress(CScriptID(hash)).ToString();
    } else if (type == 1) {
        address = CMassGridAddress(CKeyID(hash)).ToString();
    } else {
        return false;
    }
    return true;
...
bool getAddressesFromParams(const UniValue& params, std::vector<std::pair<uint160, int> > &addresses)
{
    if (params[0].isStr()) {
        ...
        for (std::vector<UniValue>::iterator it = values.begin(); it != values.end(); ++it) {
            ...
            CMassGridAddress address(it->get_str());
            uint160 hashBytes;
            int type = 0;
            if (!address.GetIndexKey(hashBytes, type)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid address");
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of nMGD\n"
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "    \"satoshis\"  (number) The number of nMGD of the output\n"
            "    \"height\"  (number) The block height\n"
            "  }\n"
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\"  (string) The current balance in nMGD\n"
            "  \"received\"  (string) The total number of nMGD received (including change)\n"
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"mfb4XJGyaBwNK2Lf4a7r643U3JotRYNw2T\"]}")
        );
