...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "getblockhash",           &getblockhash,           true  },
    { "blockchain",         "gettxidsbyblocknumber",  &gettxidsbyblocknumber,  true  },
    ...
    { "wallet",             "getlocktransactionsfromaddress",   &getlocktransactionsfromaddress,  true },
    ...
    { "massgrid",               "docker",           &docker,           true  },
    { "massgrid",               "masternodebroadcast",    &masternodebroadcast,    true  },
    { "massgrid",               "gobject",                &gobject,                true  },
    { "massgrid",               "voteraw",                &voteraw,                true  },
    { "massgrid",               "mnsync",                 &mnsync,                 true  },
    { "massgrid",               "spork",                  &spork,                  true  },
    { "massgrid",               "sentinelping",           &sentinelping,           true  },
#ifdef ENABLE_WALLET
    /* Wallet */
...
{
    return "> massgrid-cli " + methodname + " " + args + "\n";
}
