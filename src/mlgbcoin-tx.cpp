...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MLGBcoin Core mlgbcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mlgbcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mlgbcoin transaction") + "\n" +
              "  mlgbcoin-tx [options] -create [commands]   " + _("Create hex-encoded mlgbcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mlgbcoin transaction
