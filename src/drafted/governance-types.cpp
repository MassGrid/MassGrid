...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MassGridNetwork") type = MassGridNetwork;
    if(strType == "MassGridNetworkVariable") type = MassGridNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MassGridNetwork) s = "MassGridNetwork";
    if(type == MassGridNetworkVariable) s = "MassGridNetworkVariable";
