 ...
 *
 *   // network
 *   CMassGridNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.massgrid.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMassGridNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMassGridNetwork(UniValue objIn)
    {
...
// // can be under: MassGridNetwork
// //   -- signature requirements : Key1(User)
// class CMassGridNetworkVariable : public CGovernanceObject
// {
// private:
