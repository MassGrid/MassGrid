...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_DEVELOPER_PAYMENT:                r = SPORK_15_DEVELOPER_PAYMENT_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_DEVELOPER_PAYMENT:                return SPORK_15_DEVELOPER_PAYMENT_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_DEVELOPER_PAYMENT")                return SPORK_15_DEVELOPER_PAYMENT;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_DEVELOPER_PAYMENT:            return "SPORK_15_DEVELOPER_PAYMENT";
        default:
