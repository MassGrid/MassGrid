...
struct masternode_dockerinfo_t{     //masternode docker info 
    ...
    std::string ToString(){
        ...
        " protocolVersion: "<<protocolVersion<<" docker_version: "<<docker_version<<" joinToken: "<<joinToken<<endl;
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 50000 MGD - checking if valid masternode)
