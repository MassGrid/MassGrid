    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("MassGrid");
    QString versionText     = QString(tr("Version %1")).arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightTextMGD   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The MassGrid developers"));
    QString copyrightTextMassGrid   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The MassGrid developers"));
    ...
    QPixmap pixmapTmp = QPixmap(splashScreenPath);
    pixmap = pixmapTmp.scaled(pixmapTmp.width()*0.4,pixmapTmp.height()*0.4,Qt::IgnoreAspectRatio,Qt::SmoothTransformation);
    ...
    //pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextMGD);
    //pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextMassGrid);
