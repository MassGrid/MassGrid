...
void RPCExecutor::request(const QString& command,int& category,QString& retCommand)
{
    ...
    catch (UniValue& objError)
    {
        ...
        {   // Show raw JSON object
            //Q_EMIT reply(RPCConsole::CMD_ERROR, QString::fromStdString(objError.write()));
            category = RPCConsole::CMD_ERROR;
            retCommand = QString::fromStdString(objError.write());
        }
    }
    catch (const std::exception& e)
    {
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MassGridGUI::handleRestart()
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MassGrid RPC console.") + "<br>" +
