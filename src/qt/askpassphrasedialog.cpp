...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        CMessageBox::StandardButton retval = CMessageBox::question(this, tr("Confirm wallet encryption"),
        ...
        if(retval == CMessageBox::Ok)
        {
            if(newpass1 == newpass2)
            {
                ...
                {
                    CMessageBox::warning(this, tr("Wallet encrypted"),
                                         "<qt>" +
                ...
                {
                    CMessageBox::critical(this, tr("Wallet encryption failed"),
    ...
    case Unlock:
        ...
        {
            CMessageBox::critical(this, tr("Wallet unlock failed"),
    ...
    case Decrypt:
        ...
        {
            CMessageBox::critical(this, tr("Wallet decryption failed"),
                                  tr("The passphrase entered for the wallet decryption was incorrect."));
        }
        else
        {
    ...
    case ChangePass:
        if(newpass1 == newpass2)
        {
            ...
            {
                CMessageBox::information(this, tr("Wallet encrypted"),
