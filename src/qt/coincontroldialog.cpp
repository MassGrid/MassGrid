...
void CoinControlDialog::buttonToggleLockClicked()
{
    ...
    if(ui->radioListMode->isChecked()){
        ...
        CMessageBox::information(this, tr("lockMessageBox"),
...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    QString toolTip4 = tr("Can vary +/- %1 nMGD(s) per input.").arg(dFeeVary);
...
void CoinControlDialog::updateView()
{
    ...
    BOOST_FOREACH(const PAIRTYPE(QString, std::vector<COutput>)& coins, mapCoins) {
        ...
        BOOST_FOREACH(const COutput& out, coins.second) {
            ...
            itemOutput->setToolTip(COLUMN_AMOUNT, MassGridUnits::format(nDisplayUnit, out.tx->vout[out.i].nValue));
        ...
        if (treeMode)
        {
            ...
            itemWalletAddress->setToolTip(COLUMN_AMOUNT, MassGridUnits::format(nDisplayUnit, nSum));
