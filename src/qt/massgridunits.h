...
#ifndef MASSGRID_QT_MASSGRIDUNITS_H
#define MASSGRID_QT_MASSGRIDUNITS_H
...
/** MassGrid unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MassGridUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MassGridUnits(QObject *parent);

    /** MassGrid units.
      @note Source: https://en.massgrid.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MGD,
...
typedef MassGridUnits::Unit MassGridUnit;

#endif // MASSGRID_QT_MASSGRIDUNITS_H
