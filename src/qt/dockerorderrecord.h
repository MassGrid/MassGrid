...
#ifndef MASSGRID_QT_DOCKERORDERRECORD_H
#define MASSGRID_QT_DOCKERORDERRECORD_H
...
public:
    ...
    DockerOrderRecord(uint256 hash, qint64 time):
...
#endif // MASSGRID_QT_DOCKERORDERRECORD_H
