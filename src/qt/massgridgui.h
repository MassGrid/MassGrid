...
public:
    ...
    explicit MassGridGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MassGridGUI();
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with massgrid.conf */
    void showConfEditor();
...
private:
    void createMainWin(const PlatformStyle *platformStyle);
