...
#ifndef MLGBCOIN_QT_MLGBCOINUNITS_H
#define MLGBCOIN_QT_MLGBCOINUNITS_H
...
/** MLGBcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MLGBcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MLGBcoinUnits(QObject *parent);

    /** MLGBcoin units.
      @note Source: https://en.mlgbcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MLGB,
...
typedef MLGBcoinUnits::Unit MLGBcoinUnit;

#endif // MLGBCOIN_QT_MLGBCOINUNITS_H
