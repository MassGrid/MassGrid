...
QString MassGridUnits::name(int unit)
{
    ...
    else
    {
        switch(unit)
        {
            case MGD: return QString("tMGD");
            case mMGD: return QString("mtMGD");
            case uMGD: return QString::fromUtf8("μtMGD");
            default: return QString("???");
        }
    }
}
...
QString MassGridUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case MGD: return QString("MassGrid");
            case mMGD: return QString("Milli-MassGrid (1 / 1" THIN_SP_UTF8 "000)");
            case uMGD: return QString("Micro-MassGrid (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case MGD: return QString("TestMassGrids");
            case mMGD: return QString("Milli-TestMassGrid (1 / 1" THIN_SP_UTF8 "000)");
            case uMGD: return QString("Micro-TestMassGrid (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
...
QString MassGridUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
