...
class RawTransactionsTest(MassGridTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid massgrid address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid massgrid address" in e.error['message'])
