...
class TxnMallTest(MLGBcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 MLGB:
        ...
        # First: use raw transaction API to send 1210 MLGB to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50MLGB for another
        ...
        # Node0's total balance should be starting balance, plus 100MLGB for 
