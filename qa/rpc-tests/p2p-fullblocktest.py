...
'''
This reimplements tests from the massgridj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure massgridd isn't accepting b26
        ...
        # Extend the b28 chain to make sure massgridd isn't accepting b28
        ...
        #
        # b40 creates 3333 tx's spending the 6-sigop P2SH outputs from b39 for a total of 19443 sigops.
        ...
        #    Low-S and High-S values (whereas the massgrid code has custom code which does so);
