...
class WalletTest (MassGridTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 MGD from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 MGD in block rewards plus fees, but
        ...
        # Send 100 MGD with subtract fee from amount
        ...
        # Sendmany 100 MGD with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/massgrid/massgrid/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
        ...
        total_txs = len(self.nodes[0].listtransactions("*",94429))
        ...
        assert_equal(total_txs, len(self.nodes[0].listtransactions("*",94429)))
