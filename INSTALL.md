...
MassGrid also needs some build dependencies which are not always provided
...
https://github.com/MassGrid/MassGrid/releases

Always verify the signatures and checksums.

See doc/build-*.md for instructions on building massgridd,
the intended-for-services, no-graphical-interface,
reference implementation of MassGrid.
