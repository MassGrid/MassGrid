...
unlocked to sign the MassGrid-Qt.app bundle.
...
allowing somebody to distribute a MassGrid-Qt.app or massgrid-qt-setup.exe with a valid
...
that the massgrid-qt.exe file inside the installer had not been tampered with.
