...
unlocked to sign the MLGBcoin-Qt.app bundle.
...
allowing somebody to distribute a MLGBcoin-Qt.app or mlgbcoin-qt-setup.exe with a valid
...
that the mlgbcoin-qt.exe file inside the installer had not been tampered with.
