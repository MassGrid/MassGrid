...
This document provides guidelines for internationalization of the MassGrid software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `massgrid_en.ts` remains unchanged.
