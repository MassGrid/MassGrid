MassGrid Core version 0.10.3 is now available from:

  <https://massgrid.org/bin/massgrid-core-0.10.3/>
...
MassGrid Core has produced compatible signatures since a28fb70e in
...
(see https://github.com/massgrid/massgrid/pull/6793, as well as the 0.11.0
