MassGrid version 0.9.4 is now available from:
...
MassGrid released binaries from https://massgrid.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~massgrid/+archive/ubuntu/massgrid
- A third-party or self-compiled MassGrid

upgrade to MassGrid 0.9.4, which includes a workaround, **before** updating
OpenSSL.
