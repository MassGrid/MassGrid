MassGrid-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/massgrid/files/MassGrid/massgrid-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MassGrid
...
New/changed settings (command-line or massgrid.conf file)
--------------------------------------------------------
