MLGBcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mlgbcoin/files/MLGBcoin/mlgbcoin-0.5.4/
...
http://gitorious.org/mlgbcoin/mlgbcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MLGBcoin-Qt notifications under Growl 1.3.
Increase required age of MLGBcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMLGBcoin properly when installing MLGBcoin-Qt over it. (Windows)
