MassGrid version 0.5.4 is now available for download at:
http://sourceforge.net/projects/massgrid/files/MassGrid/massgrid-0.5.4/
...
http://gitorious.org/massgrid/massgridd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MassGrid-Qt notifications under Growl 1.3.
Increase required age of MassGrid-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMassGrid properly when installing MassGrid-Qt over it. (Windows)
