...
MassGrid 0.11.1 supports a full implementation of InstantX, Darksend improvements
and a new version of enforcement compatible with the newer MassGrid architechure.
Latest release in 0.11.1.x tree is v0.11.1.26, which is rebranding MassGrid to MassGrid.
...
- fix coin control crash https://github.com/massgrid/massgrid/pull/5700
