...
- Fixed issue with denominating small amounts of DRK in large wallet
  (http://jira.MassGrid.qa/browse/DRK-46)
...
- Fixed issue with completed amount jumping around
  (http://jira.MassGrid.qa/browse/DRK-46)
- Made messages less threatening (http://jira.MassGrid.qa/browse/DRK-60)
...
http://test.explorer.MassGrid.fr/tx/ce0ea2bdf630233955d459489b6f764e0d0bbe9e8a62531dd2a14b455626b59c
...
- Client now prioritises sending denominated funds back into Darksend. This will
  improve anonymity and help to respect the "anonymize MassGrid" amount in the
  configuration.
- fixed a bug where masternodes send failed transactions
- changed max to 100k in configuration
- added a warning message to startup (delete ~/.MassGrid/.agree_to_tou to see it)
...
- Merged rebroad's (https://github.com/rebroad) changes to bring debugging
  output more in line with the massgrid project. Output is now much cleaner and
...
http://test.explorer.MassGrid.fr/tx/6de2c5204abdea451da930f61bae0f954eef13188a3a37a572a24c9d92057d5d
...
- Added a pre-session state where the client will query a random masternode
  and ask if they can perform a merge on N MassGrid without giving any other
...
http://test.explorer.MassGrid.fr/tx/072ca56cbf705b87749513a2d2ee02080d506adcf8fe178f6dc2967f0711788e
http://test.explorer.MassGrid.fr/tx/32daa8ca46462e7e99f3532251d68a8c3835a080c937bd83b11db74e47b770ff
...
/MassGrid-qt -datadir=/home/user/.MassGrid -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:19442"
/MassGrid-qt -datadir=/home/user/.MassGrid2 -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:19442"

and even disable darksend auto-denom if wanted:
/MassGrid-qt -datadir=/home/user/.MassGrid -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:19442" -disabledarksend=1
...
- resolves issue with wallet not syncing by adding the capability to retrieve nodes through dnsseed
   (see https://github.com/MassGridproject/MassGrid/pull/21)
- Linux 32 and Mac OS X are now officially supported platforms
   (see https://github.com/MassGridproject/MassGrid/pull/17)
- improved overall unit test code coverage
   (see https://github.com/MassGridproject/MassGrid/pull/13 and https://github.com/MassGridproject/MassGrid/pull/15)
- minor documentation updates
   (https://github.com/MassGridproject/MassGrid/pull/18)
