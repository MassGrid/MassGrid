MLGBcoin Core version 0.9.2.1 is now available from:

  https://mlgbcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MLGB to 0.01 MLGB
...
- Fix "Start mlgbcoin on system login"
