MLGBcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mlgbcoin/files/MLGBcoin/mlgbcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MLGBcoin
...
New/changed settings (command-line or mlgbcoin.conf file)
--------------------------------------------------------
