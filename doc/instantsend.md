...
* WebSocket: [https://github.com/massgrid/insight-api-massgrid#web-socket-api](https://github.com/massgrid/insight-api-massgrid#web-socket-api)
* API: [https://github.com/massgrid/insight-api-massgrid#instantsend-transactions](https://github.com/massgrid/insight-api-massgrid#instantsend-transactions)
...
By default, the MassGrid daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MassGrid daemon:
