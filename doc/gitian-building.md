...
in the MassGrid repository under 'Fetch and create inputs' to install sources which require
...
MGDPATH=/some/root/path/massgrid
SIGPATH=/some/root/path/massgrid-detached-sigs
