...
* Update translations, see [translation_process.md](https://github.com/MassGrid/MassGrid/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/MassGrid/MassGrid/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for MassGrid
...
### Build and sign MassGrid for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit massgrid=v${VERSION} ../massgrid/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit massgrid=v${VERSION} ../massgrid/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit massgrid=v${VERSION} ../massgrid/contrib/gitian-descriptors/gitian-osx.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import massgrid/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
```
massgrid-${VERSION}-aarch64-linux-gnu.tar.gz
massgrid-${VERSION}-arm-linux-gnueabihf.tar.gz
massgrid-${VERSION}-i686-pc-linux-gnu.tar.gz
massgrid-${VERSION}-x86_64-linux-gnu.tar.gz
massgrid-${VERSION}-osx64.tar.gz
massgrid-${VERSION}-osx.dmg
massgrid-${VERSION}.tar.gz
massgrid-${VERSION}-win32-setup.exe
massgrid-${VERSION}-win32.zip
massgrid-${VERSION}-win64-setup.exe
massgrid-${VERSION}-win64.zip
```
The `*-debug*` files generated by the gitian build contain debug symbols
for troubleshooting by developers. It is assumed that anyone that is interested
in debugging can run gitian to generate the files for themselves. To avoid
end-user confusion about which file to pick, as well as save storage
space *do not upload these to the massgrid.org server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/MassGrid/MassGrid/releases/new) with a link to the archived release notes.
